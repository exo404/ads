...
/**
 * Utility class providing common methods for sorting algorithms, such as swapping elements,
 * comparing elements, printing arrays and lists, flipping subarrays, and checking if a collection is sorted.
 */
